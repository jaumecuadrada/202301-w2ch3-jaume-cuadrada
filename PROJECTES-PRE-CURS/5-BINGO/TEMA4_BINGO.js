...
function bingo() {
  ...
  if (introduirnombre) {
    ...
    console.log("╚═════╝░╚═╝╚═╝░░╚══╝░╚═════╝░░╚════╝░\n\n");
    console.log(
      "Has necessitat " + torns + " torns per completar el cartró.\n"
    );
    ...
    for (let i = 0; i < arraypuntuacions.length; i++) {
      console.log(
        `${i + 1} - NOM: ${arraypuntuacions[i].nom} PUNTUACIÓ: ${
          arraypuntuacions[i].puntuacio
        } `
      );
    }
    ...
    console.log(
      "FELICITATS I FINS UN ALTRE! Has necessitat " +
        torns +
        " torns per completar el cartró!"
    );
    console.log(
      "👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻"
    );
    ...
    console.log("👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻");
    console.log(
      "      A REVEURE! Has abandonat després de " + torns + " torns!"
    );
    console.log("👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻👋🏻");
  }
}
...
function explicacio() {
  ...
  do {
    ...
    console.log(
      "- L'USUARI QUE CONSEGUEIX UN BINGO AMB MENYS TORNS TINDRÀ LA PUNTUACIÓ MÉS ALTA!"
    );
    console.log(
      `✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺\n\n`
    );
